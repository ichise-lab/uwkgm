...
from accounts.rest.models.throttling import ThrottleBurstPermit
...
class UserScopedRateThrottle(ScopedRateThrottle):
    ...
    def allow_request(self, request: Request, view: APIView) -> bool:
        ...
        permits = ThrottleBurstPermit.objects.filter(api=configs.resolve('core.api.name'), user=request.user, name=self.scope)
