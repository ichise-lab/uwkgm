...
from dorest.libs.django.permissions import IsAccountManager
...
class PasswordView:
    class Reset(APIView):
        ...
        @validation.arguments.existence(strict_fields=['email'])
        ...
        @permissions.require(_or(IsAdminUser, IsAccountManager))
        @validation.arguments.existence(strict_fields=['new_password'])
